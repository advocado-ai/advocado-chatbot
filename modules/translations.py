...
*   Links to files are temporary (signed URLs) and expire after 1 hour.""",
        ...
        "timeline_intro": "Chronological view of key events in the whistleblowing and retaliation case",
        "timeline_tab_en": "📅 English",
        "timeline_tab_ja": "📅 日本語",
        "timeline_filters": "Timeline Filters",
        "filter_by_category": "Filter by Category",
        "category_all": "All Categories",
        "category_whistleblowing": "Whistleblowing",
        "category_retaliation": "Retaliation",
        "category_recognition": "Recognition",
        "category_obstruction": "Obstruction",
        "category_meeting": "Meeting",
        "category_employment": "Employment",
        "category_context": "Context",
        "event_category": "Category",
        "event_description": "Description",
        "event_evidence": "Evidence Links",
        "event_impact": "Impact",
        "event_quote": "Key Quote",
...
*   ファイルへのリンクは一時的（署名付きURL）で、1時間後に期限切れになります。""",
        ...
        "nav_timeline": "タイムライン",
        "timeline_title": "事件タイムライン",
        "timeline_intro": "内部告発と報復事件の主要な出来事の時系列ビュー",
        "timeline_tab_en": "📅 English",
        "timeline_tab_ja": "📅 日本語",
        "timeline_filters": "タイムラインフィルター",
        "filter_by_category": "カテゴリでフィルタ",
        "category_all": "すべてのカテゴリ",
        "category_whistleblowing": "内部告発",
        "category_retaliation": "報復",
        "category_recognition": "評価",
        "category_obstruction": "妨害",
        "category_meeting": "会議",
        "category_employment": "雇用",
        "category_context": "背景",
        "event_category": "カテゴリ",
        "event_description": "説明",
        "event_evidence": "証拠リンク",
        "event_impact": "影響",
        "event_quote": "重要な引用",
        "event_count": "{count} 件のイベント",
        "no_events": "選択したフィルターに一致するイベントはありません"
    }
}
